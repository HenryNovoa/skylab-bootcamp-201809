...
class App extends Component {
    ...
    render() {
        ...
        return <div>
            ...
            <Route path="/create" render={() => logic.loggedIn ? <CreateJob onHomeClick={this.handleOnHomeClick} CreateJob={this.handleOnCreateJob}/> : <Redirect to="/home" />} />
            {error && <Error message={error} />}

            <Route path="/home" render={() => logic.loggedIn ? <div> <Home  onCreateJobClick={this.handleCreateJobClick}/>
            </div> : <Redirect to="/" />} />

...
app.post('/api/user/:id',jsonBodyParser, (req, res) => {
    const { params: { id }, headers: { authorization }, body: {text} } = req
...
app.delete('/api/user/:id',jsonBodyParser, (req, res) => {
    ...
    try {
        ...
        logic.removePostit(id,req.body.id)
            .then(user =>
                res.json({
                    status: 'OK',
                    data: user
...
app.patch('/api/user/:id',jsonBodyParser, (req, res) => {
    const { params: { id }, headers: { authorization },  body: { text, postitId} } = req
